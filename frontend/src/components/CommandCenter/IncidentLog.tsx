        ...
        <div className="flex flex-col h-full">
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-2 text-cyan-400 font-mono tracking-wider">
                    ...
                    <span className="text-[10px] uppercase">Recent Incidents</span>
                </div>
                <div className="px-2 py-0.5 rounded bg-zinc-800 text-[10px] text-zinc-400 border border-zinc-700 uppercase">
            ...
            <div className="flex-1 overflow-y-auto space-y-3 pr-2 custom-scrollbar">
                {incidents.length === 0 ? (
                    <div className="h-full flex flex-col items-center justify-center opacity-30 text-center py-10">
                        ...
                        <span className="text-[10px] font-mono uppercase tracking-widest">No Sector Anomalies</span>
                    </div>
                ) : (
                        ...
                        <div key={incident.id} className="p-3 border border-red-950/30 bg-red-950/10 rounded-lg group hover:border-red-500/30 transition-colors">
                            <div className="flex items-start justify-between">
                                <div className="flex gap-3">
                                    ...
                                    <div>
                                        <div className="text-[10px] font-mono text-white mb-0.5 uppercase">{incident.description}</div>
                                        <div className="text-[9px] font-mono text-zinc-500">{incident.time}</div>
                                    </div>
                                </div>
            ...
            <div className="mt-4 pt-2 border-t border-zinc-800 text-[8px] font-mono text-zinc-600 uppercase flex justify-between">
